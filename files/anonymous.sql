...
CREATE DATABASE IF NOT EXISTS anonymous;
...
CREATE TABLE `anonymous`.`products` (
...
INSERT INTO `anonymous`.`products` (`p_id`, `p_number`, `p_name`, `p_image`, `p_amount`, `p_status`) VALUES
...
--
ALTER TABLE `anonymous`.`products`
